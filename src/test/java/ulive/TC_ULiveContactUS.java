 ...
 * 
 */
public class TC_ULiveContactUS extends UliveBaseClass {
	UserFactory user;
	User newUser;

	@Parameters({ "browser" })
	public TC_ULiveContactUS(String browser) {
		super(browser);
	}
	...
	private void verifyCompletedContactUSPage() {
		...
		PeonyAssertion
				.verifyTrue(
						isElementPresent(By
								.xpath(UliveCompletedContactUSPage.COMPLETEDCONTACTUS_VIEWOURFAQ_LINK)),
						"View Our FAQs link is displayed on Completed Contact Us Page");
		PeonyAssertion
				.verifyTrue(
						driver.findElement(
								By.xpath(UliveCompletedContactUSPage.COMPLETEDCONTACTUS_VIEWOURFAQ_LINK))
								.getAttribute("href").contains("help-faq"),
						"View Our FAQs url is correct on Completed Contact Us Page");
		PeonyAssertion
				.verifyTrue(
						isElementPresent(By
								.xpath(UliveCompletedContactUSPage.COMPLETEDCONTACTUS_CONTACTUS_LINK)),
						"Contact Us link is displayed on Completed Contact Us Page");
		PeonyAssertion
				.verifyTrue(
						driver.findElement(
								By.xpath(UliveCompletedContactUSPage.COMPLETEDCONTACTUS_CONTACTUS_LINK))
								.getAttribute("href").contains("contact-us"),
						"Contact Us url is correct on Completed Contact Us Page");
